...
const PopoverContent = ({
  ...
  return (
    <PopoverBase.Portal>
      <PopoverBase.Positioner side={side} sideOffset={4}>
        <PopoverBase.Popup
          className={cn(
            'relative z-50 min-w-[8rem] overflow-y-auto overflow-x-hidden rounded-lg border border-border bg-background text-main shadow-lg outline-hidden',
